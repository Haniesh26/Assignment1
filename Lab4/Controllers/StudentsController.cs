    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> EditMemberships(int id)
        {
            var communityViewModel = new CommunityViewModel
            {
                ...
                Students = await _context.Students.Where(i => i.ID == id).ToListAsync(),
        ...
        {
            var add = new CommunityMembership
            {
                CommunityID = communityId,
                StudentID = studentId
            };
            _context.CommunityMemberships.Add(add);
        ...
        {
            var remove = new CommunityMembership
            {
                CommunityID = communityId,
                StudentID = studentId
            };
            _context.CommunityMemberships.Remove(remove);
